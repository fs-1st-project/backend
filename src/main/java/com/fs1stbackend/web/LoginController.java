...
public class LoginController {
    ...
    public ResponseEntity<TokenAndUserDataDTO> loginUser(@RequestBody LoginDTO loginDTO) {
        System.out.println("프론트와 연결 되었습니다");
            ...
            TokenAndUserDataDTO tokenAndUserDataDTO = loginService.loginUser(loginDTO);
            System.out.println("로그인 토큰이다!" + tokenAndUserDataDTO.getToken());

            // 성공적으로 토큰을 받았을 경우,  토큰과 유저 아이디 반환
            return ResponseEntity.ok().body(tokenAndUserDataDTO);
    }
